        ...
        <div>
            {
                ...
                <div className="pr-[10px]">
                    ...
                    {products.map((product) => (
                        <div className="grid grid-cols-4 items-center p-[10px] w-full shadow-lg rounded-[10px] mb-[15px]" key={product.id}>
                            <div className="product-item-img flex items-center">
                                <img className="h-[50px] w-[50px] mr-[10px]" src={require(`../../${product.img}`)} alt="" />
                                <p>{product.name}</p>
                            </div>
                            <div className="flex justify-center">
                                <p>&#8358;{product.price}.00</p>
                            </div>
                            <CartButton updateItemQuantity={updateItemQuantity} product={product} />
                    ...
                    <div className="product-items-delivery">
                        ...
                        <div className="p-[10px] mb-[10px] rounded-[10px] border-[1px]">
                            ...
                            <input className="w-90 h-full border-0 rounded-none" type="text" />
                        </div>
                        <div className="p-[10px] mb-[10px] rounded-[10px] border-[1px]">
                        ...
                        <select className="h-[37px] w-full px-[10px] rounded-[10px] border-[1px] " name="list-of-drivers" id="list-of-drivers">
